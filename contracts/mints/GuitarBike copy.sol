...
contract PrivilegedTigerClub is ERC721Enumerable, Ownable {
    ...
    address payable private _PaymentAddress =
        payable(0x44B638F9457a572DF9d48228bcC4749b4F6144F7);
    ...
    constructor() ERC721("Bike Guitar", "BIKEGUT") {}
    ...
    function purchase(uint256 numberOfTokens) external payable {
        require(
            _publicGUITAR.current() < GUITAR_MAX,
            "Purchase would exceed GUITAR_MAX"
        );
